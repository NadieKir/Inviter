import { DateTimePicker, FormikStepper, IStep, ImagePreviewMode, ImageUploader, Select, TextField } from "components";
...
const requiredFieldsSchema = Yup.object().shape({
    ...
    [EventFormFields.Address]: Yup.string()
...
const additionalFieldsSchema = Yup.object().shape({
    [EventFormFields.Image]: Yup.string(),
